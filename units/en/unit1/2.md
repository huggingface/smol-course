...
- **Chat Template**: A structured format for structuring interactions between language models, users, and external tools.
- **Supervised Fine-Tuning**: The technique we will use to train the model to generate appropriate responses.
...
SmolLM3 uses a common chat template that handles multiple conversation types. Let's examine how it works:
