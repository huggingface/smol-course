...
![Fine-Tuning Course thumbnail](https://github.com/huggingface/smol-course/raw/main/banner.png)

Welcome to the comprehensive (and smollest) guide to **Fine-Tuning Language Models**!
...
Don't forget to [**sign up to the course!**](https://huggingface.co/llm-course)
...
| 2       | Preference Alignment              | Learn about RLHF, DPO, and other preference alignment techniques to make models follow human preferences like ChatGPT. |
